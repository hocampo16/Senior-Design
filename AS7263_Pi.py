...
def get_calibrated_values():
 ...
 colour_bytes[23]]
	...
	calibrated_values.append(struct.unpack('>f', bytearray(s))[0])
	calibrated_values.append(struct.unpack('>f', bytearray(t))[0])
	calibrated_values.append(struct.unpack('>f', bytearray(u))[0])
	calibrated_values.append(struct.unpack('>f', bytearray(v))[0])
	calibrated_values.append(struct.unpack('>f', bytearray(w))[0])
